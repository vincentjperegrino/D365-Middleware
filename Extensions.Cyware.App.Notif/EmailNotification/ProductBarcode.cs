...
namespace KTI.Moo.Extensions.Cyware.App.Queue.EmailNotification
{
    public class ProductBarcode : CompanySettings
    {
        ...
        public ProductBarcode(IQueueService queueService, IEmailNotification emailNotification, INotification teamsNotification)
        {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages = _queueService.RetrieveAndPopMessage(ConnectionString, "moo-cyware-extension-productbarcode-dispatcher-poison", ExtensionArchiveQueueName, 32, log);
