...
{
    public class Discount : Moo.Cyware.Helpers.CompanySettings
    {
        private readonly IEmailNotification _emailNotification;
        private readonly IQueueService _queueService;
        private readonly INotification _teamsNotification;

        public Discount(IEmailNotification emailNotification, IQueueService queueService, INotification teamsNotification)
        {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages =  _queueService.RetrieveAndPopMessage(ConnectionString, "moo-cyware-extension-discount-dispatcher-poison", ExtensionArchiveQueueName, 32, log);
