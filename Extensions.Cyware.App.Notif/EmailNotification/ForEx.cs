...
namespace KTI.Moo.Extensions.Cyware.App.Queue.EmailNotification
{
    public class ForEx : CompanySettings
    {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages = _queueService.RetrieveAndPopMessage(ConnectionString, "moo-cyware-extension-forex-dispatcher-poison", ExtensionArchiveQueueName, 32, log);
