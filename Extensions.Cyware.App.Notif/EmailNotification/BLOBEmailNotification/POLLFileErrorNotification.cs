...
{
    public class POLLFileErrorNotification : CompanySettings
    {

        private readonly IBlobService _blobService;

        public POLLFileErrorNotification(IBlobService blobService)
        {
            _blobService = blobService;
        }

        [FunctionName("POLLFile-Error-Notification")]
        public async Task RunAsync([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            mail.Subject = "POLL ErrorNotification";
            ...
            try
            {
                ...
                BlobContainerClient containerClient = blobServiceClient.GetBlobContainerClient("errorpollfiles");
                ...
                await foreach (BlobItem blobItem in containerClient.GetBlobsAsync())
                {
                    if (!blobItem.Name.Contains("archive"))
                    {
                        ...
                        _blobService.MoveBlob("errorpollfiles", blobName, destinationBlobName);
                    }
