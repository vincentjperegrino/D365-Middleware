...
namespace CRM.Models.Sales
{
    ...
    public class Order
    {
        ...
        public CRM.CustomDataType.MooDateTime datefulfilled { get; set; }
        [StringLength(2000)]
        ...
        public CRM.CustomDataType.MooDateTime submitdate { get; set; }
        [Range(0, 1000000000)]
    ...
    public class OrderDetails
    {
        ...
        public CRM.CustomDataType.MooDateTime billingstartdate { get; set; }
        ...
        public CRM.CustomDataType.MooDateTime requestdeliveryby { get; set; }
