...
namespace TestCyware.EmailNotification
{
    public class ProductCategoryTest
    {
        ...
        private Mock<ILogger<ProductCategory>> _loggerMock;
        ...
        public ProductCategoryTest()
        {
            ...
            _loggerMock = new Mock<ILogger<ProductCategory>>();

            _productCategory = new ProductCategory(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _productCategory.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
