...
namespace TestCyware.EmailNotification
{
    public class ProductsTest
    {
        ...
        private Mock<ILogger<Products>> _loggerMock;
        ...
        public ProductsTest()
        {
            ...
            _loggerMock = new Mock<ILogger<Products>>();

            _products = new Products(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _products.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
