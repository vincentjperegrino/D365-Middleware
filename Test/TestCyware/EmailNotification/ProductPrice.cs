...
namespace TestCyware.EmailNotification
{
    public class ProductPriceTest
    {
        ...
        private Mock<ILogger<ProductPrice>> _loggerMock;
        ...
        public ProductPriceTest()
        {
            ...
            _loggerMock = new Mock<ILogger<ProductPrice>>();

            _productPrice = new ProductPrice(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _productPrice.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
