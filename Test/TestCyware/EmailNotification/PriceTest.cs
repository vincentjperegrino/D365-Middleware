...
namespace TestCyware.EmailNotification
{
    public class PriceTest
    {
        ...
        private Mock<ILogger<Price>> _loggerMock;
        ...
        public PriceTest()
        {
            ...
            _loggerMock = new Mock<ILogger<Price>>();

            _price = new Price(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _price.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
