...
namespace TestCyware.EmailNotification
{
    public class ProductBarcodeTest
    {
        ...
        private Mock<ILogger<ProductBarcode>> _loggerMock;

        private ProductBarcode _productBarcode;

        public ProductBarcodeTest()
        {
            _queueServiceMock = new Mock<IQueueService>();
            _emailNotificationMock = new Mock<IEmailNotification>();
            _loggerMock = new Mock<ILogger<ProductBarcode>>();

            _productBarcode = new ProductBarcode(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _productBarcode.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
