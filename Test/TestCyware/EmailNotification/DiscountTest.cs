...
namespace TestCyware.EmailNotification
{
    public class DiscountTests
    {
        ...
        private Mock<ILogger<Discount>> _loggerMock;
        ...
        public DiscountTests()
        {
            ...
            _loggerMock = new Mock<ILogger<Discount>>();

            _discount = new Discount(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _discount.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
