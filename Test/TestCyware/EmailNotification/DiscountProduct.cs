...
namespace TestCyware.EmailNotification
{
    public class DiscountProductTest
    {
        ...
        private Mock<ILogger<DiscountProduct>> _loggerMock;

        private DiscountProduct _discountProduct;

        public DiscountProductTest()
        {
            _queueServiceMock = new Mock<IQueueService>();
            _emailNotificationMock = new Mock<IEmailNotification>();
            _loggerMock = new Mock<ILogger<DiscountProduct>>();

            _discountProduct = new DiscountProduct(_queueServiceMock.Object, _emailNotificationMock.Object);
        }
            ...
            var messages = new List<Dictionary<string, string>>
        {
            ...
            // Act
            _discountProduct.Run(new TimerInfo(null, new ScheduleStatus()), _loggerMock.Object);
