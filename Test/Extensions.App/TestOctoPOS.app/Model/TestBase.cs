...
namespace TestOctoPOS.app.Model;
...
public class TestBase
{
    ...
    public KTI.Moo.Extensions.OctoPOS.Service.Config ConfigTest = new()
    {
        apiAuth = ApiAuth,
    ...
    public KTI.Moo.Extensions.OctoPOS.Service.Config ConfigProductionToTesting = new()
    {
        apiAuth = "TU9PQ0VOVFJBTEFQSVVTRVI=,WkVkV2VtUkhVa2hXYm5CclVWRQ==",
        redisConnectionString = redisConnectionString,
        companyid = "3388",
    ...
    public KTI.Moo.Extensions.OctoPOS.Service.Config NewConfigProductionToTesting = new()
    {
        apiAuth = "TUFHRU5UT0FQSVVTRVI=,WlMxRThLdG9FYWxZZ3cx",
        redisConnectionString = redisConnectionString,
        companyid = "3388",
