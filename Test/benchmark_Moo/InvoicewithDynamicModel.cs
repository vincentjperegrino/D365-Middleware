...
public class InvoicewithDynamicModel
{
    public InvoicewithDynamicModel(KTI.Moo.Extensions.OctoPOS.Model.InvoiceItem _invoiceDetails)
    {
        #region properties
        ...
        custom_attributes = new modelfordynamic()
        {
            salesman = _invoiceDetails.SalesmanName,
            discountpercentage = _invoiceDetails.DiscountPercentage,
            taxpercentage = _invoiceDetails.TaxPercentage
        };
    ...
    public dynamic custom_attributes { get; set; }

    #endregion
}


public class modelfordynamic
{
