...
public class CustomerReport : TestBase
{
    ...
    public KTI.Moo.Extensions.Core.Domain.ISearch<KTI.Moo.Extensions.OctoPOS.Model.DTO.Customers.Search, KTI.Moo.Extensions.OctoPOS.Model.Customer> _extensionsSearchDomain;
    ...
    public void SampleSendReportToTeams_NCCICustom()
    {
        ...
        _extensionsSearchDomain = new KTI.Moo.Extensions.OctoPOS.Domain.Customer(NewProdToStagingconfig, _cache);
        _crmSearchDomain = new KTI.Moo.CRM.Domain.Customer(3389);
        ...
        var domain = new KTI.Moo.Operation.OctoPOS.Domain.Reports.Customer(
            _connectionstring,
            _IsProduction,
            _storeCode,
            _client_webhookURL,
