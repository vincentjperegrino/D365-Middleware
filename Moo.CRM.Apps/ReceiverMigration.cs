...
public class ReceiverMigration
{

    //[Singleton(Mode = SingletonMode.Listener)]
    [FunctionName("CRM-Receiver-migration")]
    public void Run([QueueTrigger("%CompanyID%-crm-migration", Connection = "AzureQueueConnectionString")] string myQueueItem, ILogger log)
    {
