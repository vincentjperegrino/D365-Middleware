...
namespace KTI.Moo.Operation.OctoPOS.App.Dispatcher;

public class DailyReport_Customer
{
    private readonly KTI.Moo.Operation.Core.Domain.Reports.ICustomer<KTI.Moo.Extensions.OctoPOS.Model.Customer, KTI.Moo.CRM.Model.CustomerBase> _customerReportService;

    public DailyReport_Customer(ICustomer<Extensions.OctoPOS.Model.Customer, CustomerBase> customerReportService)
    {
