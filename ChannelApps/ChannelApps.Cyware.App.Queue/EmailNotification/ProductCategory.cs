...
namespace KTI.Moo.ChannelApps.Cyware.App.Queue.EmailNotification
{
    public class ProductCategory : CompanySettings
    {
        ...
        public ProductCategory(IEmailNotification emailNotification, IQueueService queueService, INotification teamsNotification)
        {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages = _queueService.RetrieveAndPopMessage(ConnectionString, "rdf-cyware-channelapp-productcategory-dispatcher-poison", ChannelArchiveQueueName, 32, log);
