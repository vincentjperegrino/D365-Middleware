...
namespace KTI.Moo.ChannelApps.Cyware.App.Queue.EmailNotification
{
    public class Price : CompanySettings
    {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages = _queueService.RetrieveAndPopMessage(ConnectionString, "rdf-cyware-channelapp-price-dispatcher-poison", ChannelArchiveQueueName, 32, log);
