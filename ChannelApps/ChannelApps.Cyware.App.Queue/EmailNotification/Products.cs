...
namespace KTI.Moo.ChannelApps.Cyware.App.Queue.EmailNotification
{
    public class Products : CompanySettings
    {
        ...
        public Products(IEmailNotification emailNotification, IQueueService queueService, INotification teamsNotification)
        {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages = _queueService.RetrieveAndPopMessage(ConnectionString, "rdf-cyware-channelapp-products-dispatcher-poison", ChannelArchiveQueueName, 32, log);
