...
namespace KTI.Moo.ChannelApps.Cyware.App.Queue.EmailNotification
{
    public class ProductPrice : CompanySettings
    {
        ...
        public ProductPrice(IEmailNotification emailNotification, IQueueService queueService, INotification teamsNotification)
        {
        ...
        public void Run([TimerTrigger(TimerTriggerConfig)] TimerInfo myTimer, ILogger log)
        {
            ...
            try
            {
                var retrievedMessages = _queueService.RetrieveAndPopMessage(ConnectionString, "rdf-cyware-channelapp-productprice-dispatcher-poison", ChannelArchiveQueueName, 32, log);
