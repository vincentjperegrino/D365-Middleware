...
public class Invoice : CompanySettings
{
    ...
    public void Run([QueueTrigger("%CompanyID%-sap-%StoreCode%-channelapp-invoice-dispatcher", Connection = "AzureQueueConnectionString")] string myQueueItem, ILogger log)
    {
