...
public class Customer : CompanySettings
{
    ...
    public void Run([QueueTrigger("%CompanyID%-sap-%StoreCode%-channelapp-customer-dispatcher", Connection = "AzureQueueConnectionString")] string myQueueItem, ILogger log)
    {
