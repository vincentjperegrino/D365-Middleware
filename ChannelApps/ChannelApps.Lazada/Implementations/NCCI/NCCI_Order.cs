...
public class Order : Core.Domain.IOrder<ChannelApps.Model.NCCI.Receivers.Order, ChannelApps.Model.NCCI.Receivers.Customer, ChannelApps.Model.NCCI.Receivers.Invoice> , IOrderForReceiver
{
    ...
    public Model.NCCI.Receivers.Customer GetClientModelCustomer(string decodedJsonString)
    {
        ...
        return new Model.NCCI.Receivers.Customer(CustomerModel);
    }
    ...
    public Model.NCCI.Receivers.Order GetClientModelOrder(string decodedJsonString)
    {
        var JsonSettings = new JsonSerializerSettings
        {
            ContractResolver = new Core.Helpers.JSONSerializer.DontIgnoreResolver()
        ...
        return new Model.NCCI.Receivers.Order(OrderModel);
