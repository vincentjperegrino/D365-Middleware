...
namespace KTI.Moo.ChannelApps.Lazada.Implementations.CCPI;

public class Order : Core.Domain.IOrder<ChannelApps.Model.CCPI.Receivers.Order, ChannelApps.Model.CCPI.Receivers.Customer, ChannelApps.Model.CCPI.Receivers.Invoice> , IOrderForReceiver
{
    ...
    public Model.CCPI.Receivers.Customer GetClientModelCustomer(string decodedJsonString)
    {
        ...
        return new Model.CCPI.Receivers.Customer(CustomerModel);
    }

    public Model.CCPI.Receivers.Invoice GetClientModelInvoice(string decodedJsonString)
    {
        throw new NotImplementedException();
    }

    public Model.CCPI.Receivers.Order GetClientModelOrder(string decodedJsonString)
    {
        var JsonSettings = new JsonSerializerSettings
        {
            ContractResolver = new Core.Helpers.JSONSerializer.DontIgnoreResolver()
        ...
        return new Model.CCPI.Receivers.Order(OrderModel);
    ...
    private bool OrderProcess(string decodedJsonString)
    {
        ...
        var queueNameOrder = $"{_companyId}{Core.Helpers.QueueName.OrderBatch}";
