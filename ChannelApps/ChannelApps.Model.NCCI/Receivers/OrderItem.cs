...
public class OrderItem : CRM.Model.OrderItemBase
{
    ...
    public OrderItem(KTI.Moo.Extensions.Magento.Model.OrderItem _orderItem, int companyID)
    {
        #region properties
        ...
        var productResponse = modProduct.get_by_productnumber(_orderItem.sku).GetAwaiter().GetResult();
