...
namespace KTI.Moo.FO.Domain.Dispatchers.RDF;
...
public class Default : IDefault<SalesChannel>
{
    ...
    {
        string[] AllowedChannel = new string[] { Helper.ChannelOrigin.Queuename_magento,
                                                 Helper.ChannelOrigin.Queuename_sap,
                                                 Helper.ChannelOrigin.Queuename_octopos
                                               };
    ...
    {
        string[] AllowedChannel = new string[] { Helper.ChannelOrigin.Queuename_sap
                                               };
    ...
    private static bool ForOctoposCustomer_NoNeedStoreCode(string channelorigin, string domainType)
    {
        return channelorigin == Helper.ChannelOrigin.Queuename_octopos && domainType == Base.Helpers.DomainType.customer;
    }
