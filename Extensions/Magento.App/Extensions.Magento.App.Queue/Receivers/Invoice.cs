...
public class Invoice : CompanySettings
{
    ...
    private readonly Magento.Domain.Invoice _InvoiceDomain;
    public Invoice()
    {
        _InvoiceDomain = new(config);
    }

    [FunctionName("Magento_PollInvoice")]
    ...
    private bool process()
    {
        ...
        var InvoiceAddedForTheLastHour = GetInvoiceListIntheLastHour(_InvoiceDomain);
