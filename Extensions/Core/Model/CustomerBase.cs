...
namespace KTI.Moo.Extensions.Core.Model
{
    public class CustomerBase
    {
        ...
        //public virtual List<AddressBase> address { get; set; }
        //public virtual List<TelephoneBase> customer_telephone { get; set; }
        //public virtual List<EmailAddressBase> emailaddress { get; set; }
        public virtual int companyid { get; set; }
        public virtual string kti_sapbpcode { get; set; }
        [Range(1, 3)]
        ...
        public virtual string clubmembershipid { get; set; }
        public virtual string country { get; set; }
        public virtual DateTime customerjoineddate { get; set; }
        public virtual string customerjoinedoutlet { get; set; }
        public virtual string firstpointofpurchase { get; set; }
        public virtual string customertype { get; set; }
        public virtual string customerseniority { get; set; }
        public virtual string lastcoffeepurchasedate { get; set; }
        public virtual string customerstatus { get; set; }
        public virtual string changeofstatusdate { get; set; }
        public virtual string customertier { get; set; }
        public virtual string totalcoffeeqtyytd { get; set; }
        public virtual string totalmachineqtyytd { get; set; }
        public virtual string grandtotalcoffeeqty { get; set; }
        public virtual string grandtotalmachineqty { get; set; }
        public virtual string channel { get; set; }
        public virtual string soremarks { get; set; }
        public virtual string membercode { get; set; }
        public virtual string acct_w_concern { get; set; }
        public virtual string kas_name { get; set; }
