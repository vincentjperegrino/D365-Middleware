...
//        private readonly string _queueName = "cyware-currency-queue";
...
//        public void Run([QueueTrigger("moo-currency-queue", Connection = "AzureWebJobsStorage")] string myQueueItem, ILogger log)
//        {
//            try
//            {
...
//                    string filename = Path.Combine(_rootFolder, "cyware-currency.json");
