...
namespace CRM_Plugin.Models.Sales
{
    ...
    public class InvoiceHeader
    {
        ...
        public InvoiceHeader(InvoiceHeader _invoiceHeader)
        {
            ...
            this.kti_sapdocentry = _invoiceHeader.kti_sapdocentry;
            this.kti_sapdocnum = _invoiceHeader.kti_sapdocnum;
            this.companyid = _invoiceHeader.companyid;
            this.kti_socialchannelorigin = _invoiceHeader.kti_socialchannelorigin;
            #endregion
        }
        ...
        public DateTime msdyninvoicedate { get; set; }
